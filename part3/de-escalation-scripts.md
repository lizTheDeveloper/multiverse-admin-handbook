# De-escalation Scripts & Language

## Purpose

This guide provides specific language you can use in difficult situations. These scripts are:
...
## Scenario 1: Student in Emotional Crisis
...
> "I hear that you need connection. I care about your wellbeing, and that's exactly why I want you to talk to someone who can really support you through this. I'm your teacher, not a crisis counselor. Please reach out to one of those lines, and we can talk about class stuff when you're more grounded."

---

## Scenario 2: Boundary Violation (First Time)
...
### Script: Clear Boundary Setting

> "[Name], I need to set a boundary. [Specific behavior] isn't sustainable for me. Here's what works instead: [Alternative]."

**Examples:**

> "I notice you've messaged me 10 times tonight. I can't respond to DMs after 8pm. Please post questions in the forum during daytime hours, and I'll respond within 48 hours."

> "That question is more personal than I'm comfortable answering. Let's keep our conversations focused on [class topic/learning goals]."

> "I appreciate your enthusiasm, but calling me 'your soul teacher' makes me uncomfortable. I'm here to facilitate learning, not to be a guru. Let's keep our relationship professional."
...
### Script: Boundary with Consequence
...
> "We discussed on Nov 5 that I don't respond to DMs after 8pm. You've messaged me late at night three more times this week. This needs to stop. From now on, I won't read late-night messages. If it continues, we'll need to pause your participation to reassess."
...
## Scenario 4: Student Expressing Suicidal Ideation
...
### Script: Immediate Crisis Response
...
### Script: Don't Argue with Delusion
...
- Threats toward you, other students, or themselves
...
> "I'm taking this seriously. I'm ending this interaction and notifying [admin/appropriate authorities]. If you're in crisis, please call 988 or go to your nearest emergency room."

---

## Scenario 7: Student Demanding Special Treatment
...
### Script: Redirect Intensity

> "I appreciate that you value this space. I want to be clear that my role here is [teacher/facilitator], not [therapist/friend/family]."
>
> "If you're looking for deep connection or emotional support, I encourage you to build relationships with peers or seek community support outside of class. Here are some peer support resources: [links]."
...
**Don't:**
- Remove the boundary to soothe their feelings
...
## Scenario 10: Student Wants to Build/Lead Too Soon
...
### Script: Redirect to 90-Day Pause
...
## After De-escalation: Self-Care

De-escalating crises is exhausting. After any intense interaction:
1. **Debrief with another staff member** — Process what happened
2. **Document** — Write it down while it's fresh
...
**From peer support research:** Providers need support too. Don't carry this alone.
...
4. **Document and escalate** — You're not alone in this
5. **Boundaries are care** — For you, the student, and the community
